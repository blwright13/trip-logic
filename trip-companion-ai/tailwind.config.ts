    ...
    extend: {
      colors: {
        ...
        budget: {
          ...
          fill: "hsl(var(--budget-fill))",
          over: "hsl(var(--budget-over))",
        },
        timeline: {
          line: "hsl(var(--timeline-line))",
        },
        daytab: {
          DEFAULT: "hsl(var(--day-tab))",
          active: "hsl(var(--day-tab-active))",
          "active-foreground": "hsl(var(--day-tab-active-foreground))",
        },
        sidebar: {
