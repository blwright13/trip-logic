...
import type { DayPlan } from "@/components/ItineraryPanel";
...
export const initialMessages: ChatMessage[] = [
  ...
  },
  {
    id: "3",
    role: "ai",
    text: "Done! I've added TeamLab Borderless on Day 2 in the afternoon. The tickets are ¥3,200 (~$22) per person. I've adjusted the schedule so you still have time for Shibuya in the evening.",
...
export const planDescriptions: Record<PlanKey, string> = {
  A: "Balanced mix",
  B: "Budget-friendly",
  C: "Foodie focus",
};

export const planDays: Record<PlanKey, DayPlan[]> = {
  A: [
    {
      day: 1, date: "Apr 10", activities: [
    ...
    {
      day: 4, date: "Apr 13", activities: [
        { id: "4a", name: "Day trip to Kamakura", time: "9:00 AM", cost: 20, location: "Kamakura Station", category: "transport" },
        { id: "4b", name: "Great Buddha of Kamakura", time: "10:30 AM", cost: 6, location: "Kōtoku-in, Kamakura", category: "sightseeing" },
  ...
  C: [
    ...
    },
    {
      day: 4, date: "Apr 13", activities: [
        ...
        { id: "c4d", name: "Shimokitazawa cafe hopping", time: "3:00 PM", cost: 20, location: "Shimokitazawa, Tokyo", category: "cafe" },
...
export const initialDays = planDays.A;
